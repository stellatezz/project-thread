---
name: project-thread-engineering
description: Design, implement, and verify maintainable software during feature planning, phase execution, or substantial fixes. Use for decisions about component boundaries, state, contracts, reliability, and test evidence; use project-thread-review to assess resulting work.
---

# Engineer a maintainable outcome

Read relevant business rules, architecture, current consumers, implemented and rejected decisions, and cookbooks before choosing a structure. Establish the required behavior, failure consequences, compatibility obligations, and actual workload. Apply [shared record ownership](../project-thread/references/records.md); decisions go in existing plans, references, and Agent Notes, not a parallel engineering document for every task.
