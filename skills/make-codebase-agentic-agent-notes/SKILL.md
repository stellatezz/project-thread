---
name: make-codebase-agentic-agent-notes
...
Follow [record ownership](../make-codebase-agentic/references/records.md). Every non-trivial change adds or updates a note. Search active notes by problem, mechanism, and affected contract before creating another owner. Notes and tests are evidence to evaluate, not unquestionable authority.
