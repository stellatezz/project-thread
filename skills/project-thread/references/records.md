...
| --- | --- | --- |
| Context map | Links to current authorities, commands, and active work | `docs/project-thread.md` |
...
Every non-trivial change adds or updates an Agent Note, including a durable finding that changes engineering direction. Search for the current owner first. Use [Agent Notes](../../project-thread-agent-notes/SKILL.md) for lifecycle and supersession; do not duplicate those rules in plans. Trivial spelling, formatting, and mechanically obvious edits do not need ceremonial notes.
