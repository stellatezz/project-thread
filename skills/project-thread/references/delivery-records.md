...
Apply the existing [phase completion rules](records.md) and [Agent Note lifecycle](../../project-thread-agent-notes/references/lifecycle.md). An implemented decision note may accompany an unfinished phase with named verification gaps. Do not equate note lifecycle, issue resolution, and delivery completion.
