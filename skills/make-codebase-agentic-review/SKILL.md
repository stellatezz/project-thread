---
name: make-codebase-agentic-review
...
When reviewing documentation or code explanations, use [technical writing](../make-codebase-agentic-documentation/references/technical-writing.md) for semantic completeness and [document structure](../make-codebase-agentic-documentation/references/document-structure.md) for placement and navigation. Check relevant callers before judging a guarantee. Report missing conditions or misleading ownership as concrete findings; length or stylistic preference alone is not a defect. Code organization is assessed using [code structure](../make-codebase-agentic-engineering/references/code-structure.md).
