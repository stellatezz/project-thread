...
Once the project's procedure is proven, capture its local subscription, route, and verification commands in a cookbook using [the cookbook guide](../../make-codebase-agentic-documentation/references/cookbooks.md).
