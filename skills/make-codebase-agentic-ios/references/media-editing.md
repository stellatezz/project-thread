...
Record a verified new-edit-operation recipe in the project's [cookbooks](../../make-codebase-agentic-documentation/references/cookbooks.md), including save compatibility, undo/redo, preview, export, and failure checks.
