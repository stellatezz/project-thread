---
name: make-codebase-agentic-ios
...
Read [common engineering guidance](../make-codebase-agentic-engineering/SKILL.md) and the project's current plan, business/technical facts, relevant decisions, and cookbooks. Reuse the framework's record ownership, note lifecycle, and checkpoint rules.
