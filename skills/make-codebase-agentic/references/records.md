...
Apply [record dates](record-dates.md) to roadmaps, indexes, plans, separate phases, issues, checkpoints, and note naming. Roadmaps follow their own [lifecycle](../../make-codebase-agentic-roadmap/references/lifecycle.md); an implemented decision does not complete a delivery roadmap. Keep both records linked rather than combining their statuses or content.
