...
This is the standalone Make Codebase Agentic skill/plugin repository, not an iOS application. Read [the context map](docs/codebase.md) and relevant skill owners before changing behavior.
